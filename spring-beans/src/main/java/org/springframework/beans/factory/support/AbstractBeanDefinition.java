...
public abstract class AbstractBeanDefinition extends BeanMetadataAttributeAccessor
	...
	/**
	 * 是否允许访问非public方法和属性
	 * 应用于构造函数、工厂方法、init、destroy方法的解析
	 * 默认是true，表示啥都可以访问
	 */
	...
	/**
	 * 重写的方法列表
	 * 记录lookup-method、replaced-method元素  @Lookup等
	 */
	...
	/**
	 * 是否是合成对象(是不是应用自定义的)
	 * 例如生成AOP代理时，会用到某些辅助类，这些辅助类不是应用自定义的，这个就是合成类
	 * 创建AOP时候为true
	 */
